defmodule TrackerExampleWeb.RoomPresence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TrackerExample.MyChannel do
        use TrackerExampleWeb, :channel
        alias TrackerExample.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :tracker_example,
                        pubsub_server: TrackerExample.PubSub
end
